...
class DNN_Model(L.LightningModule):
    ...
    def on_train_end(self):
        ...
        plot.plot_losses(train_losses_arr, val_losses_arr, self.result_dir)
    ...
    def on_test_epoch_end(self):
        ...
        plot.plot_predictions_vs_actuals(y_true_test, y_pred_test, self.mae.compute().item(), 0, self.r2.compute().item(), self.result_dir)
        ...
        importance_means, importance_stds, baseline_r2 = metrics.calculate_feature_importance(self.model, loader, self.device, n_repeats=10)
